...
description: Enterprise-grade frontend architecture and avant-garde UI design skill for creating distinctive, production-ready interfaces. Activates automatically for all frontend/UI work including React, Vue, Svelte components, HTML/CSS layouts, web artifacts, and interface design. Features dual-mode operation with ULTRATHINK protocol for deep architectural reasoning. Always creates artifacts for UI components.
---
