...
- richer artifact interaction requires a separately versioned renderer/runtime,
...
The static-fallback claim is itself executable. `prax_teach.py visual-verify`
...
the verifier and renderer hashes. It never upgrades an unbundled interactive
or motion runtime, opaque media, factual correctness, real-browser behavior, or
human learning evidence. Declared textual answers are machine-scanned;
